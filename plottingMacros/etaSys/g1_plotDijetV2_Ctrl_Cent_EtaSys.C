...
void g1_plotDijetV2_Ctrl_Cent_EtaSys(){
	...
	TFile* f1 = new TFile("objects/roots/etasys/g1_dijetV2_etasys.root");
	TFile* f2 = new TFile("objects/roots/etasys/g1_dijetV2Cent_etasys.root");
	TFile* f3 = new TFile("objects/roots/etasys/g1_dijetRVal_etasys.root");
	TFile* f4 = new TFile("objects/roots/etasys/g1_dijetRValCent_etasys.root");
