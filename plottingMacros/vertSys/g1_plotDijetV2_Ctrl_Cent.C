...
void g1_plotDijetV2_Ctrl_Cent(){
	...
	TFile* f1 = new TFile("objects/roots/g1_dijetV2.root");
	TFile* f2 = new TFile("objects/roots/g1_dijetV2Cent.root");
	TFile* f3 = new TFile("objects/roots/g1_dijetRVal.root");
	TFile* f4 = new TFile("objects/roots/g1_dijetRValCent.root");
