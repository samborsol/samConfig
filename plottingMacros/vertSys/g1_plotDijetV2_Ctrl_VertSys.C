...
void g1_plotDijetV2_Ctrl_VertSys(){
	...
	TFile* f1 = new TFile("objects/roots/vertsys/g1_dijetV2_vertsys.root");
	TFile* f2 = new TFile("objects/roots/vertsys/g1_dijetV2Cent_vertsys.root");
	TFile* f3 = new TFile("objects/roots/vertsys/g1_dijetRVal_vertsys.root");
	TFile* f4 = new TFile("objects/roots/vertsys/g1_dijetRValCent_vertsys.root");
	...
	c1->RedrawAxis();
	c1->Draw();
	c1->Print("PLOTS/LRG/pdf/v2_pt_qtu5_final.pdf");
	c1->Print("PLOTS/LRG/png/v2_pt_qtu5_final.png");
	...
	c2->RedrawAxis();
	c2->Draw();
	c2->Print("PLOTS/LRG/pdf/v2_pt_qta5u10_final.pdf");
	c2->Print("PLOTS/LRG/png/v2_pt_qta5u10_final.png");
	...
	c3->RedrawAxis();
	c3->Draw();
	c3->Print("PLOTS/LRG/pdf/v2_pt_allQt_final.pdf");
	c3->Print("PLOTS/LRG/png/v2_pt_allQt_final.png");
	...
	c4->RedrawAxis();
	c4->Draw();
	c4->Print("PLOTS/LRG/pdf/v2_pt_qtu5_subbed.pdf");
	c4->Print("PLOTS/LRG/png/v2_pt_qtu5_subbed.png");
	...
	c5->RedrawAxis();
	c5->Draw();
	c5->Print("PLOTS/LRG/pdf/v2_pt_qta5u10_subbed.pdf");
	c5->Print("PLOTS/LRG/png/v2_pt_qta5u10_subbed.png");
	...
	c6->RedrawAxis();
	c6->Draw();
	c6->Print("PLOTS/LRG/pdf/v2_pt_allQt_subbed.pdf");
	c6->Print("PLOTS/LRG/png/v2_pt_allQt_subbed.png");	
	...
	c7->RedrawAxis();
	c7->Draw();
	c7->Print("PLOTS/LRG/pdf/v2_pt_qtu5_mixed.pdf");
	c7->Print("PLOTS/LRG/png/v2_pt_qtu5_mixed.png");	
	...
	c8->RedrawAxis();
	c8->Draw();
	c8->Print("PLOTS/LRG/pdf/v2_pt_qta5u10_mixed.pdf");
	c8->Print("PLOTS/LRG/png/v2_pt_qta5u10_mixed.png");	
	...
	c9->RedrawAxis();
	c9->Draw();
	c9->Print("PLOTS/LRG/pdf/v2_pt_allQt_mixed.pdf");
	c9->Print("PLOTS/LRG/png/v2_pt_allQt_mixed.png");
	...
	c10->RedrawAxis();
	c10->Draw();
	c10->Print("PLOTS/LRG/pdf/v2_pt_qtu5_raw.pdf");
	c10->Print("PLOTS/LRG/png/v2_pt_qtu5_raw.png");
	...
	c11->RedrawAxis();
	c11->Draw();
	c11->Print("PLOTS/LRG/pdf/v2_pt_qta5u10_raw.pdf");
	c11->Print("PLOTS/LRG/png/v2_pt_qta5u10_raw.png");
	...
	c12->RedrawAxis();
	c12->Draw();
	c12->Print("PLOTS/LRG/pdf/v2_pt_allQt_raw.pdf");
	c12->Print("PLOTS/LRG/png/v2_pt_allQt_raw.png");		


	//R-Value A
	TCanvas* c13 = new TCanvas("c13","c13",800,800);
	p18 = (TProfile*)f3->Get("p18");
	...
	c13->RedrawAxis();
	c13->Draw();
	c13->Print("PLOTS/LRG/pdf/rval_v2_pt_qtu5.pdf");
	c13->Print("PLOTS/LRG/png/rval_v2_pt_qtu5.png");
	...
	c14->RedrawAxis();
	c14->Draw();
	c14->Print("PLOTS/LRG/pdf/rval_v2_pt_qta5u10.pdf");
	c14->Print("PLOTS/LRG/png/rval_v2_pt_qta5u10.png");
	...
	c15->RedrawAxis();
	c15->Draw();
	c15->Print("PLOTS/LRG/pdf/rval_v2_pt_allQt.pdf");
	c15->Print("PLOTS/LRG/png/rval_v2_pt_allQt.png");
	...
	c16->RedrawAxis();
	c16->Draw();
	c16->Print("PLOTS/LRG/pdf/v2_QT_final.pdf");
	c16->Print("PLOTS/LRG/png/v2_QT_final.png");
}
